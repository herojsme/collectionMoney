<template>
    <view class="protocol">
        <view class="main">
            ...
            <view>1.3 eID服务体系对于同一用户，在不同的互联网应用中产生的eID数字身份并不相同，即碎片化处理，防止被大数据技术追踪；</view>
            <view>1.4 eID数字身份由“公安部公民网络身份识别系统”统一管理，碎片化处理后的eID数字身份可以有条件进行同一化处理。</view>
            ...
            <view>2.2 在通过相符性比对后，三所为您签发eID数字身份。您的eID数字身份与您申请时提供的身份信息及人脸信息唯一关联。</view>
            ...
            <view>4.2 您授权并同意三所基于您的姓名、身份号码生成您的eID数字身份，并将您的eID数字身份向为您提供服务的应用方提供以完成实名登记、实名认证要求。</view>
            <view>4.3 在您通过eID数字身份向为您提供服务的应用证明您的身份时，您授权并同意三所将相符性比对结果转发给向您提供服务的应用方，由其判断是否通过您的实名实人认证。</view>
            <view>
                4.4
            ...
            <view class="strong">5.1 请您提供真实、准确的姓名、身份号码，否则，无法为您生成eID数字身份；</view>
            <view class="strong">5.2 请您提供本人的姓名、身份号码、人脸图像，并申请本人的eID数字身份。冒用他人身份者将承担身份冒用带来的一切后果与责任。</view>
