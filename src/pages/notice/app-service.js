...
$gwx5 = function (path, global) {
    ...
    var m1 = function (e, s, r, gg) {
        ...
        var xC = _mz(
            z,
            'van-tabs',
            ['sticky', -1, 'swipeable', -1, 'active', 0, 'bind:change', 1, 'class', 1, 'color', 2, 'lineHeight', 3, 'lineWidth', 4, 'titleActiveColor', 5, 'titleInactiveColor', 6],
            [],
            e,
            s,
            gg
        ...
        var oD = _n('van-tab');
        _rz(z, oD, 'title', 8, e, s, gg);
        var fE = _mz(z, 'view', ['class', 9, 'id', 1], [], e, s, gg);
        var cF = _v();
        _(fE, cF);
        if (_oz(z, 11, e, s, gg)) {
            cF.wxVkey = 1;
            ...
            var oH = function (oJ, cI, lK, gg) {
                var tM = _mz(z, 'view', ['bindtap', 14, 'class', 1, 'data-item', 2], [], oJ, cI, gg);
                var eN = _v();
                _(tM, eN);
        ...
        _(xC, oD);
        var oP = _n('van-tab');
        _rz(z, oP, 'title', 19, e, s, gg);
        var xQ = _mz(z, 'view', ['class', 20, 'scrollY', 1], [], e, s, gg);
        var oR = _v();
        _(xQ, oR);
        if (_oz(z, 22, e, s, gg)) {
            oR.wxVkey = 1;
            ...
            var cT = function (oV, hU, cW, gg) {
                var lY = _mz(z, 'view', ['bindtap', 25, 'class', 1, 'data-item', 2], [], oV, hU, gg);
                var aZ = _v();
                _(lY, aZ);
                if (_oz(z, 28, oV, hU, gg)) {
                    aZ.wxVkey = 1;
                }
                var t1 = _v();
                _(lY, t1);
                if (_oz(z, 29, oV, hU, gg)) {
                    t1.wxVkey = 1;
                }
                aZ.wxXCkey = 1;
                t1.wxXCkey = 1;
...
__wxAppCode__['notice/noticeDetail/noticeDetail.json'] = {
    usingComponents: {},
...
__wxAppCode__['notice/noticeList/noticeList.json'] = {
    usingComponents: {
...
__wxRoute = 'notice/noticeList/noticeList';
__wxRouteBegin = true;
__wxAppCurrentFile__ = 'notice/noticeList/noticeList.js';
define(
    'notice/noticeList/noticeList.js',
    function (
        require,
        module,
        exports,
        ...
        export default {
            ...
            onReachBottom: function () {
                0 == this.active &&
                    this.currentPageSys * this.pageSize <= this.noticeDataList.length &&
                    (this.setData({
                        currentPageSys: this.currentPageSys + 1
                    }),
                    this.queryCustSysNotice()),
                    1 == this.active &&
                        this.currentPagePer * this.pageSize <= this.noticePersonalList.length &&
                        (this.setData({
...
require('./notice/noticeList/noticeList.js');
__wxRoute = 'notice/noticeDetail/noticeDetail';
__wxRouteBegin = true;
__wxAppCurrentFile__ = 'notice/noticeDetail/noticeDetail.js';
define(
    'notice/noticeDetail/noticeDetail.js',
    function (
        require,
        module,
        exports,
            ...
            onLoad: function (n) {
                console.log(n),
                    this.setData({
                        title: n.title,
                        time: n.time,
                        imgUrl: decodeURIComponent(n.imgUrl),
                ...
                noticeEvent: function (t) {
                    ...
                    if (0 == this.active) {
                        ...
                        this.reqReadNoticeStatus(e),
                            a >= 0 && ((e.isRead = 'read'), (this.noticeDataList[a] = e)),
                            this.setData({
                    ...
                    if (1 == this.active) {
                        ...
                        this.reqReadPersonalNoticeStatus(e),
                            i >= 0 && ((e.readStatus = 1), (this.noticePersonalList[i] = e)),
                            this.setData({
                ...
                queryCustSysNotice: function () {
                    ...
                    t.queryCustSysNotice({
                        ...
                        uni.hideLoading(),
                            ...
                            200 == t.code
                                ? t.object.totalCount > 0 &&
                                  e.setData({
                                      noticeDataList: e.noticeDataList.concat(t.object.list)
                                  })
                                : uni.showToast({
                                      title: t.message,
                                      icon: 'none'
                ...
                queryCustPerNotice: function () {
                    ...
                    t.queryCustPerNotice({
                        ...
                        uni.hideLoading(),
                            ...
                            200 == t.code
                                ? e.setData({
                                      noticePersonalList: e.noticePersonalList.concat(t.object.list)
                                  })
                                : uni.showToast({
                                      title: t.message,
                                      icon: 'none'
...
require('./notice/noticeDetail/noticeDetail.js');
