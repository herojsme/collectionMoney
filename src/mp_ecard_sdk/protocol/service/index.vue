<template>
    <view class="protocol">
        <view class="main">
            ...
            <view>如果您是未成年人，请在法定监护人的陪同下阅读本协议及上述其他协议，并特别注意涉及未成年人使用本服务的相关条款。</view>
            <view>如果您在阅读本协议过程中有任何问题，请您联系我们，我们将对相关内容进行解释和说明，以使您能够充分理解并自主判断和决定是否接受本协议内容。</view>
            ...
            <view>
                ...
                <view class="strong" style="display: inline">，具体服务流程为：</view>
            </view>
            <view class="strong">
            ...
            <view>2.1腾讯有权根据您的申请情况，决定是否为您提供腾讯E证通服务。</view>
            <view>2.2腾讯有权在腾讯以及腾讯合作方的具体产品业务中推广、应用腾讯E证通服务。</view>
            <view class="strong">
            ...
            <view>
                ...
                <view class="strong" style="display: inline">您应妥善保管您的手机设备、账号、密码以及动态验证码等资料，并对该账号项下所从事的行为承担相应的法律责任。</view>
            </view>
            <view class="strong">
            ...
            <view class="strong">2.6使用腾讯E证通服务过程中，如果您的个人信息有更新，您应及时进行更新。否则，因此产生的法律责任由您承担。</view>
            <view class="strong">2.7如果您的账户、终端设备因信息泄露、遗失或被非授权使用所致的损失由您自行承担。</view>
            <view class="strong">
            ...
            <view class="strong">2.9您所申请的eID数字身份仅供您个人使用，您不得将您的eID数字身份提供给他方使用，您应对您的eID数字身份所从事的行为承担法律责任。</view>
            <view>2.10为了向您提供更优的服务，腾讯有权对腾讯E证通服务系统进行升级、改造。</view>
            <view>
                2.11如果您需要注销腾讯E证通服务，您可以在腾讯E证通小程序中的
                <view class="strong" style="display: inline">“关于腾讯E证通-意见反馈”</view>
            ...
            <view>
                ...
                <navigator class="protocol_sprotocol" style="display: inline" url="/mp_ecard_sdk/protocol/privacy/index">《隐私政策》</navigator>
            ...
            <view>3.4 腾讯将运用各种安全技术和程序建立完善的管理制度来保护您的个人信息，以免遭受未经授权的访问、使用或披露。</view>
            <view>3.5如您希望访问、撤回授权、修改、删除您的个人信息，您可以通过“关于腾讯E证通-意见反馈”联系我们，并提供必要的身份证明。</view>
            <view class="strong">
            ...
            <view class="strong">4.2在法律允许的范围内，腾讯对以下情形导致的本服务中断或受阻不承担责任：</view>
            <view class="strong">4.2.1受到计算机病毒、木马或其他恶意程序、黑客攻击的破坏；</view>
            <view class="strong">4.2.2网络故障、网络异常；</view>
            <view class="strong">4.2.3用户操作不当；</view>
            <view class="strong">4.2.4用户通过非经我们授权的方式使用本服务；</view>
            <view class="strong">4.2.5其他腾讯无法控制或合理预见的情形。</view>
            <view class="strong">
                4.3
            ...
            <view class="strong underline">5.1 本协议的成立、生效、履行、解释及纠纷解决，适用中华人民共和国大陆地区法律（不包括冲突法规则）。</view>
            <view class="strong underline">
                5.2 若您和腾讯之间发生任何纠纷或争议，首先应友好协商解决；若协商不成的，您和腾讯同意将纠纷或争议提交本协议签订地有管辖权的人民法院，通过诉讼加以解决。
            </view>
            <view class="strong underline">5.3本协议签订地为中华人民共和国广东省深圳市南山区。</view>
            <view class="strong underline">5.4本协议所有条款的标题仅为阅读方便，本身并无实际涵义，不能作为本协议涵义解释的依据。</view>
            <view class="strong underline">5.5本协议条款无论因何种原因部分无效或不可执行，其余条款仍有效，对双方具有约束力。（正文完）</view>
        </view>
    </view>
</template>
