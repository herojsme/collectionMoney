    ...
    <view>
        <view class="login_container">
            ...
            >
                ...
                <view>
                    <van-cell-group>
                        <van-field :border="false" inputAlign="right" label="姓名" :value="value" placeholder="请输入真实姓名"></van-field>
                        <van-field :border="false" inputAlign="right" label="身份证号" :value="value" placeholder="请输入身份证号"></van-field>
            ...
            <van-popup @close="onClose" :closeOnClickOverlay="true" position="bottom" :show="showStartTime">
                <van-datetime-picker
            ...
            <van-popup @close="onClose" :closeOnClickOverlay="true" position="bottom" :show="showEndTime">
                <van-datetime-picker
            ...
            >
                <view style="margin: 80rpx">
                    <text style="color: #666666; text-align: center">您的身份证已注册过，是否继续认证？</text>
                </view>
            </van-dialog>
            <view class="login_btnBox">
                <view class="loginBindBtn">
                    <van-button round @tap.native="clickCommit" customClass="confirm_button" type="info">提交</van-button>
                </view>
            </view>
        </view>
    </view>
...
<script>
var e;
if ((e = require('../../../miniprogram_npm/@vant/weapp/dialog/dialog'))) {
    e.__esModule;
}
var app = getApp();
export default {
    data() {
        return {
            ...
            showEndTime: false,
            bankCardnumber: 'xx',
            scrollHeight: app.globalData.windowHeight - app.globalData.navhegiht - 100,
